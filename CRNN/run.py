...
def parse_arguments():
    ...
    parser.add_argument(
        "--save_test_img",
        action="store_true",
        help="Define if you wish to save text image with predicted output of CRNN as name of the image. This would be useful for analysis of output"
    )
