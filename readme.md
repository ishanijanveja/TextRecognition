To develop a premise for the task that this repository intends to preform, read [TextRecognition-CRNN.pdf](https://github.com/ishanijanveja/TextRecognition/blob/master/TextRecognition-CRNN.pdf)
